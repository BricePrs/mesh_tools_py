...
use ultraviolet::{Vec3, Mat4, projection::rh_yup::perspective_gl};
...
impl Camera {
    ...
    pub fn new(position: Vec3, world_up: Vec3, pitch: f32, yaw: f32, fov: f32, aspect: f32) -> Self {
    ...
    pub fn get_view_matrix(&self) -> Mat4 {
        Mat4::from_euler_angles(0., -self.pitch, -self.yaw).transposed() * Mat4::from_translation(self.position)
    }
